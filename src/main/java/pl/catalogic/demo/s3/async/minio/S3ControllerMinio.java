...
//
//      s3ServiceMinio.uploadFile(bucketName, file.getOriginalFilename(), tempFile);
//      tempFile.delete();
//
...
//    s3ServiceMinio.enableReplication(replicatedBucketName,destinationBucketName);
