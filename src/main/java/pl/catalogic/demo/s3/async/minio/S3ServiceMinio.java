...
//    List<Bucket> buckets = s3ClientMinio.listBuckets().buckets();
...
//    }
//
//    s3ClientMinio.createBucket(CreateBucketRequest.builder().bucket(bucketName).build());
...
//      s3ClientMinio.getObject(getObjectRequest, ResponseTransformer.toFile(targetPath));
...
//      s3ClientMinio.putObject(request, requestBody);
...
//        .build();
//
//    CreateMultipartUploadResponse response = s3ClientMinio.createMultipartUpload(createRequest);
...
//            .build();
//        UploadPartResponse uploadPartResponse = s3ClientMinio.uploadPart(uploadPartRequest, RequestBody.fromBytes(buffer));
...
//        .build();
//
//    CompleteMultipartUploadResponse completeResponse = s3ClientMinio.completeMultipartUpload(completeRequest);
...
//        .uploadId(uploadId)
//        .build();
//    s3ClientMinio.abortMultipartUpload(abortRequest);
//  }
//
...
//        .build();
//
//    s3ClientMinio.putBucketReplication(request);
//  }
//
//
//}
